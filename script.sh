...
gnome-terminal --tab --title="Users database" -- bash -c "iex --name u_db1@$IP --cookie a_cookie -S mix; $SHELL" #user database
gnome-terminal --tab --title="Messages database" -- bash -c "iex --name m_db1@$IP --cookie a_cookie -S mix; $SHELL" #message database
=======
gnome-terminal --tab --title="Client" -- bash -c "iex --name client@$IP --cookie a_cookie -S mix; $SHELL" #client
gnome-terminal --tab --title="Directory" -- bash -c "iex --name dir@$IP --cookie a_cookie -S mix; $SHELL" #directory
